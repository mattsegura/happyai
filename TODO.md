...
- [x] Test the fix: Run `npm run dev`, navigate to dashboard, click bell icon on desktop (md+ breakpoint), verify dropdown appears on top without hiding behind components.
- [x] Update TODO.md: Mark edit as complete and test as done.
- [x] If mobile issues: Adjust positioning for small screens or add responsive checks.
