...
export const mockCourseGrades: { [courseId: string]: Grade } = {
  '1': { letter: 'B', percentage: 87 },
  '2': { letter: 'C', percentage: 76 },
  '3': { letter: 'A', percentage: 94 },
  '4': { letter: 'B', percentage: 85 },
  '5': { letter: 'A', percentage: 91 },
};
...
// Mock assignments for analytics and testing
export const mockAssignments: CanvasAssignment[] = [
  ...
  },
  {
    ...
    points: 100,
    type: 'project',
    description: 'Presentation on World War II',
    estimatedHours: 5,
  },
  {
    id: '6',
  ...
  },
  {
    ...
    points: 300,
    type: 'project',
    description: 'Research paper on genetics',
    estimatedHours: 10,
  },
  {
    id: '8',
    ...
    points: 50,
    type: 'quiz',
    description: 'Quick quiz on atomic theory',
    estimatedHours: 1,
  },
];
