...
import { Sparkles, Mail, Lock, Eye, EyeOff, GraduationCap, Users } from 'lucide-react';
...
export function LoginPage({ onToggleMode }: LoginPageProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-400 via-blue-500 to-indigo-600 flex items-center justify-center p-3 sm:p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative">
        <div className="bg-white/95 backdrop-blur-xl rounded-2xl sm:rounded-3xl shadow-2xl p-5 sm:p-8 border border-white/20">
          <div className="flex justify-center mb-4 sm:mb-6">
            <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-2xl flex items-center justify-center shadow-lg transform hover:scale-110 transition-transform duration-300">
          ...
          <p className="text-center text-sm sm:text-base text-gray-600 mb-4 sm:mb-6">
            Connect with your emotions and classmates
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full pl-10 sm:pl-12 pr-3 sm:pr-4 py-3 sm:py-4 bg-gray-50 border-2 border-transparent rounded-xl focus:outline-none focus:border-cyan-500 focus:bg-white transition-all duration-300 text-sm sm:text-base text-gray-800 placeholder:text-gray-400"
              />
            </div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full pl-10 sm:pl-12 pr-10 sm:pr-12 py-3 sm:py-4 bg-gray-50 border-2 border-transparent rounded-xl focus:outline-none focus:border-cyan-500 focus:bg-white transition-all duration-300 text-sm sm:text-base text-gray-800 placeholder:text-gray-400"
              />
              <button
                type="button"
          ...
          <div className="mt-5 sm:mt-6 text-center">
            <button
              ...
              className="text-xs sm:text-sm text-gray-600 hover:text-cyan-600 transition-colors font-medium"
            >
