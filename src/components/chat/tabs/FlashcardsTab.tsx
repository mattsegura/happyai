...
export function FlashcardsTab() {
  ...
  return (
    <div className="flex h-full">
      {/* History Sidebar */}
      <ToolHistorySidebar
        items={flashcardSetHistory}
        title="Previous Flashcard Sets"
        onSelectItem={(item) => {
          console.log('Selected flashcard set:', item);
          // In a real app, this would load that specific flashcard set
        }}
      />
