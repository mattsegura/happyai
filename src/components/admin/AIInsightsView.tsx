            ...
            <CardContent>
              <div className="space-y-3">
                {mockCorrelationAnalysis.aiRecommendations.map((rec, idx) => (
                  <div key={idx} className="flex gap-3 p-4 rounded-lg bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-900/50">
            ...
            <CardContent>
              <div className="space-y-4">
                {mockEmotionalTrendsAnalysis.concerningTrends.map((trend, idx) => (
                  <div key={idx} className="rounded-lg border border-orange-200 dark:border-orange-900/50 bg-orange-50 dark:bg-orange-950/20 p-4">
            ...
            <CardContent>
              <div className="space-y-3">
                {mockAcademicRiskDriversAnalysis.departmentBreakdown
                  ...
                  .map((dept) => (
                    <div key={dept.department} className="flex items-center justify-between p-3 rounded-lg border border-border bg-card">
                      <div className="flex-1">
