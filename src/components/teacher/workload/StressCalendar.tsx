          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4 p-4 bg-muted/50 rounded-lg">
              <div>
                ...
                <p className="text-2xl font-bold">{selectedDay.totalAssignments}</p>
              </div>
              <div>
                <p className="text-sm text-muted-foreground">Total Exams</p>
                <p className="text-2xl font-bold">{selectedDay.totalExams}</p>
              </div>
              <div>
            ...
            {selectedDay.teacherAssignments.length > 0 && (
              <div>
                ...
                <div className="space-y-2">
                  {selectedDay.teacherAssignments.map((assignment) => (
                    <div
                      key={assignment.id}
            ...
            {selectedDay.crossClassAssignments.length > 0 && (
              <div>
                ...
                <div className="space-y-2">
                  {selectedDay.crossClassAssignments.map((assignment) => (
                    <div
                      key={assignment.id}
