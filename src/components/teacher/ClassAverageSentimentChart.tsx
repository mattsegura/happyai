...
function getBlueShade(value: number): string {
...
export function ClassAverageSentimentChart() {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-black rounded-3xl p-6 border-2 border-blue-200 shadow-lg">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-2">
          ...
          <div>
            <h3 className="text-lg font-bold text-white">Class Sentiment Journey</h3>
            <p className="text-xs text-gray-400">Track class emotional wellness over time</p>
          </div>
        </div>
      ...
      <div className="mb-4 flex items-center space-x-4">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-sm text-gray-400">
            Avg: <span className="font-bold text-white">{average.toFixed(1)}/6.0</span>
          </span>
        </div>
        <div className={`flex items-center space-x-1 px-3 py-1 rounded-full ${
          trend === 'up' ? 'bg-green-900/50 text-green-400' : 'bg-orange-900/50 text-orange-400'
        }`}>
