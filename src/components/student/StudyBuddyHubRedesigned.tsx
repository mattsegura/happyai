...
import {
  BookOpen, Plus, Clock, CheckCircle, Target, TrendingUp,
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-muted-foreground">
              Create study plans to understand material, not just complete it. Upload notes to generate flashcards, quizzes, and summaries. Each plan has an AI tutor that remembers everything.
            </p>
          </div>
          <motion.button
